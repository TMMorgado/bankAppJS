...
const account1 = {
  ...
  movements: [200, 450, -400, 3000, -650, -130, 70, 1300,130.55, 240.3],
  interestRate: 1.2, // %
  pin: 1111,
  iban: 1220,
    movementsDates: [
    ...
    '2025-12-16T10:51:36.790Z',
    '2025-12-17T21:31:17.178Z',
    '2025-12-18T07:42:02.383Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
accRec.movementsDates.push(new Date().toISOString())
updateUI(currentAcc); 
